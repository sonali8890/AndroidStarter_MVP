...
import com.sixthsense.android.constants.APIConstants;
import com.sixthsense.android.network.NoInternetConnectionException;
import com.starterapp.android.BuildConfig;
...
public class NetworkModule {
    ...
    public boolean isNetworkConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) StarterApp.getApplicationInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
